  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <img className='w-5 cursor-pointer sm:hidden' src={assets.menu_icon} onClick={()=>setVisible(true)} alt="" />  
        </div>
            {/* Sidebar menu for small screens */}
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full flex flex-col': 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    <div className='flex items-center gap-4 p-3 onClick={()=>setVisible(false)} cursor-pointer'>
